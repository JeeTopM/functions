...
которые начинаются на буквы А и М (независимо от регистра) и имеют длину больше 4.
...
filter_names = filter(lambda x: x[0].upper() in ('А','М') and len(x) > 4, names)
sorted_names = sorted(map(lambda x: x.title(), filter_names))
print(*sorted_names)